%GENERATE_DOTS_RANDOM_DIST   Random dot patterns (distractors).
%   GENERATE_DOTS_RANDOM_DIST generates random dot patterns.
...
fill(x*size1x*faktor(1) + x_pos(1),	y*size1y*faktor(1) + y_pos(1), dotcolor, 'EdgeColor', dotcolor);
...
fill(x*size1x*faktor(1) + x_pos(1),	y*size1y*faktor(1) + y_pos(1), dotcolor, 'EdgeColor', dotcolor);
fill(x*size1x*faktor(2) + x_pos(2),	y*size1y*faktor(2) + y_pos(2), dotcolor, 'EdgeColor', dotcolor);
...
fill(x*size1x*faktor(1) + x_pos(1),	y*size1y*faktor(1) + y_pos(1), dotcolor, 'EdgeColor', dotcolor);
fill(x*size1x*faktor(2) + x_pos(2),	y*size1y*faktor(2) + y_pos(2), dotcolor, 'EdgeColor', dotcolor);
fill(x*size1x*faktor(3) + x_pos(3),	y*size1y*faktor(3) + y_pos(3), dotcolor, 'EdgeColor', dotcolor);
...
fill(x*size1x*faktor(2) + x_pos(2),	y*size1y*faktor(2) + y_pos(2), dotcolor, 'EdgeColor', dotcolor);
fill(x*size1x*faktor(3) + x_pos(3),	y*size1y*faktor(3) + y_pos(3), dotcolor, 'EdgeColor', dotcolor);
fill(x*size1x*faktor(4) + x_pos(4),	y*size1y*faktor(4) + y_pos(4), dotcolor, 'EdgeColor', dotcolor);
